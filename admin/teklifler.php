...
if(isset($_GET['sil'])){
    ...
    adminFlash('Rezervasyon talebi silindi.');
...
$durumlar = [
  ...
  'teklif_verildi' => ['Onaylandı','bg-primary'],
...
<div class="card mb-4">
  <div class="card-header d-flex justify-content-between">
    <div><i class="bi bi-calendar2-check me-2" style="color:var(--primary)"></i><strong>Rezervasyon #<?= $detay['id'] ?></strong> — <?= e($detay['ad']) ?></div>
  ...
  <div class="card-body">
    <div class="row g-3 mb-3">
      ...
      <div class="col-md-3"><small class="text-muted">Ne İçin</small><div><strong><?= e($detay['hizmet']) ?></strong></div></div>
      ...
      <div class="col-md-3"><small class="text-muted">Masa / Alan</small><div><?= e($detay['butce'])?:'—' ?></div></div>
...
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div><i class="bi bi-calendar2-check me-2"></i>Tüm Rezervasyonlar (<?= count($liste) ?>)</div>
  ...
  <div class="table-responsive">
    <table class="table table-hover align-middle mb-0">
      <thead><tr><th>#</th><th>Ad</th><th>Telefon</th><th>Ne İçin</th><th>Masa</th><th>Durum</th><th>Tarih</th><th></th></tr></thead>
      <tbody>
      ...
      <?php endforeach; ?>
      <?php if(empty($liste)): ?><tr><td colspan="8" class="text-center text-muted py-4">Henüz rezervasyon talebi yok.</td></tr><?php endif; ?>
      </tbody>
    </table>
  </div>
</div>
